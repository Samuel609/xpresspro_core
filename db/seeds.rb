...
Sightseeing.create!(
  location: 'Aifel Tower',
  description: 'A large park with scenic views and recreational activities.',
  price_per_hour: 30,
  time_spent: 1,
  image: 'https://media.istockphoto.com/id/1436430810/photo/paris-eiffel-tower.jpg?s=612x612&w=0&k=20&c=twnPoKvqoTpraJNYTNrLBKASWjExRQMxoY9XPkHWJFQ='
)
...
Sightseeing.create!(
  ...
  price_per_hour: 40,
  time_spent: 1,
  image: 'https://images.unsplash.com/photo-1507840771025-26e8ececa04c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
)
...
Sightseeing.create!(
  ...
  price_per_hour: 20,
  time_spent: 1,
  image: 'https://images.unsplash.com/photo-1500078974918-738828bc0422?q=80&w=1931&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
)
